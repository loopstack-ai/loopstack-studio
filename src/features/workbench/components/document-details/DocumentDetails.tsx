...
const DocumentDetails: React.FC<DocumentDetailsProps> = ({ data }) => {
  ...
  return (
    <div className="mt-4">
      <Accordion
        type="multiple"
        defaultValue={['document-info', 'content', 'schema']}
        className="space-y-2"
      >
          ...
          <AccordionContent>
            <div className="ml-6 space-y-2">
              ...
              {data.meta?.enableAtPlaces && (
                <div className="pt-2">
                  <div className="text-sm font-medium mb-2">Enable At Places:</div>
                  <div className="flex flex-wrap gap-2">
              ...
              <div className="pt-2 space-y-1">
                <div className="text-sm">
                  ...
                  {data.isInvalidated ? 'Yes' : 'No'}
                </div>
                <div className="text-sm">
                  <span className="font-medium">Pending Removal:</span>{' '}
                  {data.isPendingRemoval ? 'Yes' : 'No'}
                </div>
                <div className="text-sm">
          ...
          <AccordionContent>
            <Card className="bg-gray-50">
              <CardContent className="p-4">
                <pre
                  className={`whitespace-pre-wrap break-words text-xs p-2 rounded bg-gray-100 max-h-96 overflow-auto ${
        ...
        <AccordionItem value="schema">
          ...
          <AccordionContent>
            <Card className="bg-gray-50">
              <CardContent className="p-4">
                <pre className="whitespace-pre-wrap break-words font-mono text-xs p-2 rounded bg-gray-100">
                  {schemaContent}
                </pre>
              </CardContent>
            </Card>
